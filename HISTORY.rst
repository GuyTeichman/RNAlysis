...
Changed
*******
* Renamed several vague GUI button labels to clearer, action-oriented text: multi-value input buttons ("Set input") now read "Choose values", and the button that confirms loading a table or creating a Pipeline ("Start") now reads "Open table" / "Create Pipeline" respectively. This is a labeling change only; behavior is unchanged.
