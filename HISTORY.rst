...
Changed
*******
* Improved the look of enrichment plots generated by FeatureSets.enrich_randomization() and FeatureSets.enrich_randomization_parallel().
* FeatureSet.enrichment_randomization() and FeatureSet.enrichment_randomization_parallel() can now return the enrichment plot's Figure object in addition to the results DataFrame.
