...
* FeatureSet.enrichment_randomization() and FeatureSet.enrichment_randomization_parallel() now return the enrichment plot's Figure object in addition to the results DataFrame. 
