...
@pytest.mark.parametrize(
    'from_dict,to_dict,from_names,to_names,is_legal',
    [
        ...
        ({'one': 1, 'three': 3}, {'two': 2, 'three': 3}, ['one', 'two', 'three'], ['two', 'three'], False),
    ],
)
...
@pytest.mark.parametrize(
    'min_cluster_size,metric,cluster_selection_method,n_features,expected_to_pass',
    [
...
@pytest.mark.parametrize(
    'test_input,expected_type,expected',
    [
        (
            [
                '3',
...
@pytest.mark.parametrize(
    'test_input,parent_class,expected',
    [
...
@pytest.mark.parametrize(
    'metric,linkage,expected_to_pass',
    [
...
@pytest.mark.parametrize(
    'threshold,expected_to_pass',
    [(5, True), (0.1, True), ('5', False), ([5, 6], False), (0, True), (0.0, True), (-2, False), (-3.14, False)],
)
...
@pytest.mark.parametrize(
    'path,accept_gtf,accept_gff3,err_exp,truth',
    [
