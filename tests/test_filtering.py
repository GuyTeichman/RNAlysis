...
def test_text_filters_ew():
    truth = general.load_csv(r'tests/test_files/text_filters_ew.csv', 0)
    d = CountFilter(r'tests/test_files/text_filters.csv')
...
def test_filter_by_row_sum():
    truth = general.load_csv('tests/test_files/test_filter_row_sum.csv', 0)
    h = CountFilter('tests/test_files/counted.csv')
...
def test_sort_not_inplace():
    c = CountFilter('tests/test_files/counted.csv')
    c_copy = general.load_csv('tests/test_files/counted.csv', 0)
...
def test_sort_by_multiple_columns():
    truth = general.load_csv('tests/test_files/counted_sorted_multiple_truth.csv', 0)
    c = CountFilter('tests/test_files/counted.csv')
...
def test_sort_with_na_first():
    truth_first = general.load_csv('tests/test_files/test_deseq_with_nan_sorted_nanfirst_truth.csv', 0)
    truth_last = general.load_csv('tests/test_files/test_deseq_with_nan_sorted_nanlast_truth.csv', 0)
